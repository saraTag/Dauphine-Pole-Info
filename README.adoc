...
* Ouaaz Chahine :Déploiement automatique sur IBM cloud de l'ancienne application (PI3), la nouvelle application et vérifier que les deux communiquent et marchent.
