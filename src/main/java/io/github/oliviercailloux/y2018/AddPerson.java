...
public class AddPerson {
	...
	public Response add(@QueryParam("firstname") String fname,@QueryParam("lastname") String lname,@QueryParam("email") String email,@QueryParam("phone") String phone,@QueryParam("fax") String fax,@QueryParam("homePage") String homePage) {
		
		Person per =new Person(fname,lname,email,phone,fax,homePage);
		CreatePerson(per);
